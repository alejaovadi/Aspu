                                    ...
                                    <main id="main2">
                                        ...
                                        <h4
                                            ...
                                            <ol class="breadcrumb font-weight-bold mb-3">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript:void(0)">Comentarios</a>
                                                </li>
                                                <li class="breadcrumb-item active">Ver Comentarios</li>
                                            </ol>
                                        </h4>
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${comentarios}" var="comentario">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ${comentario.getNoticiaId().getTitulo()}
                                                                    </td>
                                                                    <td>
                                                                        ${comentario.getUsuarioUsuario().getNombre()}
                                                                    </td>

                                                                    <td>
                                                                        ${comentario.obtenerFecha()}
                                                                    </td>

                                                                    <td>


                                                                        <a type="button" class="btn btn-danger btn-xs " data-toggle="modal" data-target="#myModalEliminar${comentario.getId()}">
                                                                            ...
                                                                            <div class="modal-dialog modal-sm">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    <div class="modal-body">
                                                                                        ...
                                                                                        <p class="text-center">Esta seguro que desea Eliminar este Comentario <strong>${comentario.getMensaje()}</strong> ?</p>

                                                                                        <div style="text-align: center;">
                                                                                            <a href="Comentario?action=delete&id=${comentario.getId()}" class="btn btn-danger">Eliminar</a>
                                                                                        </div>
