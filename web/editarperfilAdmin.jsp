                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div style="margin-bottom: 20px;" class="form-group">
                                                        ...
                                                        <br>
                                                        <input style="width: 100%;" type="text" value="${admin.getUsuario()}" class="form-control" id="usuario" name="usuario" required="" readonly="">
                                                    </div>
                                                    <div style="margin-bottom: 20px;" class="form-group">
                                                        <label for="documento">Nombres</label>
                                                        <br>
                                                        <input style="width: 100%;" type="text" value="${admin.getNombre()}" class="form-control" id="nombre" name="nombre" required="">
                                                    </div>
                                                    <div style="margin-bottom: 20px;" class="form-group">
                                                        <label for="documento">Apellidos</label>
                                                        <br>
                                                        <input style="width: 100%;" type="text" value="${admin.getApellido()}" class="form-control" id="apellido" name="apellido" required="">
                                                    </div>
                                                ...
                                                <div class="col-6">
                                                    <div style="margin-bottom: 20px;" class="form-group">
                                                        ...
                                                        <input style="width: 100%;" type="text" value="${admin.getEmail()}" class="form-control" id="email" name="email" required="">
                                                    </div>

                                                    <div style="margin-bottom: 20px;" class="form-group">
                                                        <label for="celular">Contraseña</label>
                                                        <input style="width: 100%;" type="password" value="${admin.getPassword()}" class="form-control" id="clav" name="clav" required="" readonly="">
