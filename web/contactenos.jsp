					...
					<div class="container-fluid flex-grow-1 container-p-y">
						<h4
							...
							<ol class="breadcrumb font-weight-bold mb-3">
								...
								<li class="breadcrumb-item"><a href="javascript:void(0)">Contactenos</a>
								</li>
						...
						<div class="row">
							<div class="col-6">
								...
								<div
									class="card bg-transparent border-dark mb-3 box-shadow-none">
									<div class="card-body">
										<h4 class="card-title">SECCIONAL ASPU-UFPS</h4>
										<p class="card-text">
											Dirección: <small>Universidad Francisco de Paula
												Santander, Edificio Fundadores, Cuarto Piso</small>
										</p>
										<p class="card-text">
											Tel. <small>5776655 Ext. 229. </small>
										</p>
										<p class="card-text">
											Cel. <small>3175766851 </small>
										</p>
										<p class="card-text">
											Email: <small>aspu.ufps@gmail.com </small>
										</p>
										<p class="card-text">
											Presidente: <small>Adolfo Ibarra Romero. </small>
										</p>
									</div>
								</div>
							...
							<div class="col-6">
								...
								<div
									class="card bg-transparent border-dark mb-3 box-shadow-none">
									<div class="card-body">
										<h4 class="card-title">ASPU NACIONAL</h4>
										<p class="card-text">
											Email: <small>asospu.bog@gmail.com</small>
										</p>
										<p class="card-text">
											Telefax: <small>571-2229718 </small>
										</p>
									</div>
								</div>
