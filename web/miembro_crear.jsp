                                ...
                                <main id="main2">
                                    <h4
                                        ...
                                        <ol class="breadcrumb font-weight-bold mb-3">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript:void(0)">Miembro</a>
                                            </li>
                                            <li class="breadcrumb-item active">Registrar Miembro</li>
                                        </ol>
                                    </h4>

                                    <form action="Miembro?action=save" method="post">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="documento">Nombres</label>
                                                    <input type="text" class="form-control" id="nombre" placeholder="Nombres del miembro" name="nombre" required="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nombre">E-mail</label>
                                                    <input type="text" class="form-control" id="email" placeholder="Correo del miembro" name="email" required="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="descripcion" placeholder="Descripcion del miembro" name="descripcion" required="">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="tel" placeholder="Telefono del miembro" name="tel" required="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="nombre">Titulo</label>
                                                    <input type="text" class="form-control" id="titulo" placeholder="Titulo del Miembro" name="titulo" required="">
